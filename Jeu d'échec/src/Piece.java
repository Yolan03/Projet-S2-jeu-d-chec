...
public abstract class Piece implements Mouvement, Serializable{
	...
	public static List<Position> posPrisesNoir = new ArrayList<Position>(); //utilis� pour le roi
	...
	protected boolean bloqueEnnemi(Position mouvement) //bloqu� par piece ennemie
	{
		List<Piece> tempTab=new ArrayList<Piece>();
